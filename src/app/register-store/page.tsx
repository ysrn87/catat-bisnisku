...
export default function RegisterStorePage() {
  ...
  useEffect(() => {
    if (!slugManual && storeName) setStoreSlug(slugify(storeName));
  ...
  useEffect(() => {
    const t = setTimeout(() => checkSlug(storeSlug), 500);
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="storeName" className="text-xs font-medium">Nama Toko <span className="text-red-500">*</span></Label>
              <Input
            ...
            <div className="space-y-1.5">
              <Label htmlFor="storeSlug" className="text-xs font-medium">URL Toko <span className="text-red-500">*</span></Label>
              <div className="flex items-center gap-2">
                <span className="text-xs text-gray-400 whitespace-nowrap">domain.com/</span>
            ...
            {/* Nama — hanya untuk user baru */}
            {!isExistingUser && (
              <div className="space-y-1.5">
                <Label htmlFor="ownerName" className="text-xs font-medium">Nama Lengkap <span className="text-red-500">*</span></Label>
                <Input
                  id="ownerName" name="ownerName" type="text"
            ...
            <div className="space-y-1.5">
              <Label htmlFor="ownerPassword" className="text-xs font-medium flex items-center gap-1.5">
                ...
                {isExistingUser && <span className="text-gray-400 font-normal ml-1">(password akun kamu)</span>}
              </Label>
              <div className="relative">
                <Input
            ...
            {/* Info toko tambahan untuk user existing */}
            {isExistingUser && (
            ...
            >
              {loading ? (
                ...
                <><Store className="w-4 h-4 mr-2" />Buat Toko Baru</>
              ) : (
