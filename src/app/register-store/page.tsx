          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                className="h-10 text-sm focus-visible:ring-[#1ecbe1]"
              />
            </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="relative flex-1">
                  <Input
                    ...
                    className="h-10 text-sm focus-visible:ring-[#1ecbe1] pr-24"
                  />
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <Input
                  ...
                  className="h-10 text-sm pr-10 focus-visible:ring-[#1ecbe1]"
                />
            ...
            {/* Plan info */}
            <div className="p-3 bg-[#e0f9fc] rounded-lg border border-[#a8f0f8] text-xs text-gray-600 space-y-1.5">
